...
const URL_TTD_DEFAULT = "https://vuzwlgwzhiuosgeohhjl.supabase.co/storage/v1/object/public/letters-archive/surat-ttd.png";
                 ...
                 <div className="text-[12pt] space-y-6 leading-relaxed">
                    ...
                    <div className="mt-12 text-center">
                       ...
                       <div className="flex justify-center -mt-4">
                           <img src={URL_TTD_DEFAULT} className="w-full max-w-[550px] object-contain opacity-95" alt="TTD"/>
                       </div>
                    </div>
                 </div>
              </div>

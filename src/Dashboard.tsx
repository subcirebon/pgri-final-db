        ...
        <div className="bg-gradient-to-r from-pink-600 to-rose-600 rounded-[28px] p-6 text-white shadow-xl relative overflow-hidden">
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-xl font-black capitalize aeac word italic tracking-wider">Rekan Seperjuangan Berulang Tahun!</h3>
              <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-4">
                {birthdays.map((m) => (
                  <div key={m.id} className="flex items-center gap-3 bg-white text-pink-700 px-4 py-2 rounded-2xl text-xs font-black shadow-lg">
                    ...
                    <button onClick={() => window.open(`https://wa.me/${m.phone}?text=_Selamat Ulang Tahun! Semoga Usia, Rizki dan Kesehatanmu Diberkahi Tuhan._`, '_blank')} className="text-green-600 hover:scale-110 transition-transform"><MessageCircle size={18} /></button>

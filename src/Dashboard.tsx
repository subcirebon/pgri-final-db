...
const Dashboard = () => {
  // 1. Mengambil data userName langsung dari sistem login lewat context
  ...
  // State untuk Foto Profil Permanen
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // 2. AMBIL FOTO PROFIL DARI DATABASE BERDASARKAN USERNAME LOGIN
      if (userName) {
  ...
  // 3. FUNGSI UPLOAD FOTO PROFIL AGAR PERMANEN DI DATABASE
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      // Update kolom avatar_url di tabel members secara permanen
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-2xl font-black text-gray-800 uppercase italic leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-7 rounded-[32px] border border-gray-100 shadow-sm hover:shadow-md transition-all flex flex-col">
